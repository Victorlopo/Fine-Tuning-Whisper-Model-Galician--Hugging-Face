# -*- coding: utf-8 -*-
"""training_medium_30.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1aRj6ccXUtuPeth0cv7ldP1upeDaF7q0D
...
#processor = WhisperProcessor.from_pretrained("openai/whisper-medium", language="Galician", task="transcribe", chunk_length=10)
processor = WhisperProcessor.from_pretrained("openai/whisper-medium", language="Galician", task="transcribe")

from transformers import WhisperTokenizer

#tokenizer = WhisperTokenizer.from_pretrained("openai/whisper-medium", language="Galician", task="transcribe", chunk_length=10)
...
training_args = Seq2SeqTrainingArguments(
    #num_train_epochs=1,
    output_dir="./whisper-medium-gl-30",  # chSange to a repo name of your choice
...
kwargs = {
    ...
    "language": "gl",
    "model_name": "Whisper Medium gl - Galician - 30sec",  # a 'pretty' name for our model
